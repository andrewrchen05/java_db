...
public class Ticketmaster{
	...
	public static void AddBooking(Ticketmaster esql){//2 works!
		...
		try {// Shows the us
			String query_theaters = "SELECT SS.sid, SS.ssid, SS. price, SS.csid, CS.tid, T.tname\n FROM Showseats SS, Cinemaseats CS, Theaters T, Cinemas C\n WHERE SS.sid = '" 
		...
		try {// Shows the us
			String query_mvid_show_times = "SELECT SS.sid, SS.ssid, SS. price, SS.csid, CS.tid, T.tname, C.cname\n FROM Showseats SS, Cinemaseats CS, Theaters T, Cinemas C\n WHERE SS.sid = '" 
